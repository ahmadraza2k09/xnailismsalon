...
const es = {
  ...
  home: {
    ...
    instagramSubtitle:
      "Explora el perfil oficial de Instagram en vivo. Mira nuestros últimos diseños de uñas, reels de proceso y actualizaciones del estudio.",
    ...
    instagramBioName: "Ximena Moreno | Artista de uñas + cursos 💅",
    instagramBioLine1: "💅 Artista de Uñas & Educadora",
    instagramBioLine2: "✨ Builder Gel · Polygel · Acrílico · Cursos Presenciales",
  ...
  booking: {
    ...
    stepWhenNote: "Lunes a viernes de 10:00 a 19:00, sábados de 10:00 a 16:00. Los domingos son solo con cita previa.",
    stepYou: "Tus datos",
    stepConfirm: "Confirma tu cita",
    selectDate: "Selecciona una fecha",
    selectTime: "Selecciona una hora",
    pickDateFirst: "Elige primero una fecha.",
    noSlots: "Este día no tiene horarios. Escríbenos por WhatsApp y lo acomodamos.",
...
const en: Dict = {
  ...
  home: {
    ...
    instagramAccent: "@x.nailsm",
    instagramSubtitle:
      "Explore our official Instagram profile screen live. View our latest nail art sets, process reels, and studio updates.",
    ...
    instagramBioName: "Ximena Moreno | Nail Artist + Courses 💅",
    instagramBioLine1: "💅 Nail Artist & Educator",
    instagramBioLine2: "✨ Builder Gel · Polygel · Acrylic · Workshops",
  ...
  booking: {
    ...
    stepWhenNote: "Monday to Friday 10:00 to 19:00, Saturday 10:00 to 16:00. Sundays are by appointment only.",
    stepYou: "Your information",
    stepConfirm: "Confirm appointment",
    selectDate: "Select a date",
    selectTime: "Select a time",
    pickDateFirst: "Pick a date first.",
    noSlots: "No times on this day. Write on WhatsApp and we will fit you in.",
