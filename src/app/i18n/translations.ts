...
const es = {
  ...
  about: {
    ...
    teamTitle: "Nuestras",
    teamAccent: "Especialistas",
    teamSubtitle: "Conoce a las profesionales detrás de X.Nailsm",
    ximenaBadge: "Fundadora & Artista",
    ximenaExp: "9+ años oficio",
    ximenaSpec1: "Nivelación de Builder Gel, Polygel y Acrílico esculpido",
    ximenaSpec2: "Diseños asiáticos de autor pintados a mano al detalle",
    ximenaHoursTitle: "Horarios de Ximena:",
    ximenaHours1: "• Mar, Jue, Sáb y Dom: 7:00 am - 9:00 pm",
    ximenaHours2: "• Lun, Mié y Vie: 7:00 am - 3:00 pm",
    karelliPartnerBadge: "Socia",
    karelliSpec1: "Pedicura en seco (limpieza profunda, cutícula y limado preciso)",
    karelliSpec2: "Ritual Tina Spa con sales epsom aromáticas y mascarilla",
    karelliSpec3: "Técnica Acripié y diseños personalizados en pies",
    karelliBilingualTitle: "Atención Bilingüe Personalizada:",
    karelliBilingualText: "Fluidez total en Español e Inglés para asegurar la máxima comodidad durante tu cita.",
...
const en: Dict = {
  ...
  about: {
    ...
    teamTitle: "Our",
    teamAccent: "Specialists",
    teamSubtitle: "Meet the professionals behind X.Nailsm",
    ximenaBadge: "Founder & Artist",
    ximenaExp: "9+ years craft",
    ximenaSpec1: "Builder Gel levelling, Polygel & Sculpted Acrylics",
    ximenaSpec2: "Signature Asian hand-painted nail art in fine detail",
    ximenaHoursTitle: "Ximena's Hours:",
    ximenaHours1: "• Tue, Thu, Sat & Sun: 7:00 am - 9:00 pm",
    ximenaHours2: "• Mon, Wed & Fri: 7:00 am - 3:00 pm",
    karelliPartnerBadge: "Partner",
    karelliSpec1: "Dry pedicure (deep cleaning, cuticles & precision filing)",
    karelliSpec2: "Foot Spa Ritual with aromatic epsom salts & mask",
    karelliSpec3: "Acripié technique & custom foot nail designs",
    karelliBilingualTitle: "Personalised Bilingual Care:",
    karelliBilingualText: "Full fluency in Spanish and English for your complete comfort during your appointment.",
